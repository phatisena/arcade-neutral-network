...
namespace AI {
    ...
    //%blockid=ai_makenet
    //%block="make net| inputs: $Inputs outputs: $Outputs"
    ...
    //%blockid=ai_accuracy
    //%block="accuracy| netlist: $Net inputs: $Inputs outputs: $Outputs cubeinputoutput: $InputOutput"
    ...
    //%blockid=ai_randomnet
    //%block="random net| inputs: $Inputs outputs: $Outputs"
    ...
    //%blockid=ai_mix
    //%block="mix| cube1st: $FIRST inputs: $Inputs outputs: $Outputs cube2nd: $SECOND"
    ...
    //%blockid=ai_think
    //%block="think| cubenet: $Net inputs: $Inputs outputs: $Outputs"
